...
mtlb_plot(b);
// !! L.25: Unknown function grid, original calling sequence used
grid("on");

//%
// MATLAB can make other graph types as well, with axis labels.

// !! L.30: Unknown function bar, original calling sequence used
bar(b);
// !! L.31: Unknown function xlabel, original calling sequence used
xlabel("Sample #");
// !! L.32: Unknown function ylabel, original calling sequence used
ylabel("Pounds");
...
mtlb_plot(b,"*");
set(gca(),"data_bounds",matrix([0,10,0,10],2,-1));
...
// !! L.101: Unknown function poly, original calling sequence used
// L.101: Name conflict: function name changed from poly to %poly
p = round(mtlb_double(%poly(A)));
...
// !! L.108: Unknown function roots, original calling sequence used
// L.108: Name conflict: function name changed from roots to %roots
%roots(p);
