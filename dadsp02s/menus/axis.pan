...
{setvar("_replot", 0)}
 ...
 X Scale:          <R x{5} y{5}    n # >~setvar("_xlg",<{_xlg}>)~<Linear><Log>
 Label X Subtics   <c x{-1} y{15} e{_xlg}  w{15} % >~setvar("_xlgls",<{_xlgls}>)~<0><1>
 Use 10^n Labels   <c x{-2}       e{_xlg}  w{15} % >~setvar("_xlgxt",<{_xlgxt}>)~<0><1>
 Y Scale:          <R x{-1} y{5} n # >~setvar("_ylg",<{_ylg}>)~<Linear><Log>
 Label Y Subtics   <c x{-1} y{15} e{_ylg}  % >~setvar("_ylgls",<{_ylgls}>)~<0><1>
...
<L>
 ...
 {_automaticstr}   <# c x{-1} y{-1} }>~setvar("_yticaut", <{_yticaut}>);if(_yticaut, setvar("_ytc", "-1"), if(_ytc=="-1", setvar("_ytc", caststring(getytic))))~<0><1>
<L>
