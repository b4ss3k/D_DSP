...
<i{2} x{5}> ! alert icon
Your version of DADiSP requires a Password for full operation. <x{35} y{-1}>
...
Authorization <r n h x{5} t{"' Request a Password | Enter a Password | Run in Evaluation Mode | View Self Running Demo/Tutorial '"}   >~setvar(_authmode, <{_authmode}>)~<I Need a Password><I Have a Password><Run in Browser Mode><View Tutorial >
